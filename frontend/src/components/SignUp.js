        ...
        return (
            <div className={classes.display}>
                {!isRedirected ?
                    <div>
                        {loginSwitch ? (<Login />) :
                            <div className='container  col-md-4 border rounded p-5'><ToastContainer />
                                ...
                                <form onSubmit={(e) => {
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <input type="text" className="form-control" id="name" value={createForm.fullName}
                                            placeholder='Enter Your Name' onChange={updateFields} name='fullName' required />
                                    </div>
                                    <div className="mb-3">
                                        <label htmlFor="email" className="form-label">Email</label>
                                        <input type="email" className="form-control" value={createForm.email}
                                            id="email" placeholder='Enter Email' onChange={updateFields} name='email' required />
                                    </div>
                                    <div className="mb-3">
                                        <label htmlFor="password" className="form-label">Password</label>
                                        <input type="password" className="form-control"
                                            id="password" placeholder='Enter Password' name='password'
                                            onChange={updateFields} value={createForm.password} required />
                                    </div>
