    ...
    return (
        <div>
            {!isRedirected ? <div>
                {isSwitch ? (<SignUp />) :
                    (
                        <div className={classes.display}><ToastContainer />
                                ...
                                <form onSubmit={(e) => {
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <input type="email" className="form-control" id="email"
                                            placeholder="Enter Email" onChange={updateFeilds} name='email' value={createForm.email} required />
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <input type="password" className="form-control" id="password" placeholder="Enter Password"
                                            onChange={updateFeilds} name='password' value={createForm.password} required
                                        />
                                    </div>
